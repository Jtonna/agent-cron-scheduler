...
web/
  ...
  style.css          -- CSS with custom properties, dark/light theme
tests/
...
A single-page application built with vanilla JavaScript (no framework, no build
tooling, no transpilation). The entire application is wrapped in an IIFE to avoid
