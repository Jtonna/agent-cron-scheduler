...
function isJobRunning(job: Job): boolean {
  // A job is considered running when it has been triggered but has no exit code yet
  return job.last_exit_code === null && job.last_run_at !== null;
}
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button
                              ...
                              aria-label="Kill job"
                              onClick={() =>
                                handleAction(job.id, () => onKill(job.id))
                              }
                          ...
                          <TooltipContent>Kill job</TooltipContent>
                        </Tooltip>
                      ) : (
                        <Tooltip>
                          <TooltipTrigger asChild>
