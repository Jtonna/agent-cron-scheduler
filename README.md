...
A new frontend project at `electron/packages/frontend-v2/` contains the redesigned frontend with theme system, component library, layout shell with navigation, and jobs list page (issues #105, #106, #108). Run `npm test` from that directory to execute the Vitest test suite.
...
electron/                # Electron app and frontend
  packages/
    ...
    frontend-v2/         # Next.js v2 — redesigned frontend (theme, components, layout shell, dashboard, jobs list)
docs/                    # Documentation
```
