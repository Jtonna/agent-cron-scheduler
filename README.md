...
A new frontend project at `electron/packages/frontend-v2/` contains the redesigned frontend with theme system, component library, layout shell with navigation, dashboard page, jobs list page, and job detail page (issues #105, #106, #107, #108, #109). Run `npm test` from that directory to execute the Vitest test suite.
...
electron/                # Electron app and frontend
  packages/
    ...
    frontend-v2/         # Next.js v2 — redesigned frontend (theme, components, layout shell, dashboard, job pages)
docs/                    # Documentation
```
